...
public class NetworkController extends Controller {
  ...
  public static void updates() {
    ...
    NetworkUpdateType nutFavo = new NetworkUpdateType("img/favourite.png");
    NetworkUpdateType nutCompany = new NetworkUpdateType("img/company.gif");
    NetworkUpdateType nutLinkedIn = new NetworkUpdateType("img/linkedin.gif");
    ...
    networkUpdates.networkUpdates.add(new NetworkUpdate(u1, null, "08-09-2012", "Wie weet iets van Magento?", 45));
    ...
    networkUpdates.networkUpdates.add(new NetworkUpdate(u1, null, "17-08-2012", "Leuke app dit, eens kijken of ik er wat mee kan.", 3));
